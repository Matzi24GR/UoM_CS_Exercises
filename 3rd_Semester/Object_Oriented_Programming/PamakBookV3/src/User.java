...
public class User implements Serializable {
    ...
    public void addFriend(User newUser) {
        ...
        if (newUser.equals(this)) {
            throw new IllegalArgumentException("You can't add yourself as a friend");
        } else if (newUser.isFriendWith(this)) {
            throw new IllegalArgumentException("Already friends with " + newUser.getName());
        } else {
    ...
    public ArrayList<Post> getPostFeed() {
        ArrayList<Post> sortedFeed = new ArrayList<>(postList);
        for (User friend: friendList) {
